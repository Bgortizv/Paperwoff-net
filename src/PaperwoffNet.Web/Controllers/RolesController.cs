...
namespace PaperwoffNet.Web.Controllers
{
    public class RolesController : Controller
    {
        ...
        public RolesController(PaperwoffNetDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdRole,NombreRol")] Roles roles)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdRole,NombreRol")] Roles roles)
        {
            if (id != roles.IdRole)
            {
                return NotFound();
